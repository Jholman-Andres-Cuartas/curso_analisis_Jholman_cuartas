...
# Bidireccional: desde ambos lados de la asociación podemos acceder al objeto de la otra clase
# por ejemplo: desde author puedo acceder a un libro y desde libro puedo acceder al autor
